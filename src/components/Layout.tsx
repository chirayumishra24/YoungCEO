...
function FullScreenButton() {
  ...
  return (
    <button onClick={toggleFullScreen} className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/70 backdrop-blur-md border border-border-soft/20 shadow-sm text-text-dark hover:bg-primary/5 hover:text-primary transition-colors focus:outline-none" aria-label="Toggle Fullscreen">
      {isFullscreen ? (
