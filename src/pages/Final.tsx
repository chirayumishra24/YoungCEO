              ...
              <div className="grid gap-8 sm:grid-cols-2">
                {presentationItems.map((item, i) => (
                  <motion.div key={item.text}
                    ...
                    className="activity-card-nested flex flex-col items-center text-center">
                    <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-surface-muted text-3xl shadow-sm border border-white">
                      {item.emoji}
                    </div>
